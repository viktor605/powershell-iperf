...
function Connections () {
    ...
    Switch($connectoin){
        1{$connection = "Huawei"; devcon disable $bdcom_network; devcon disable $iskratel_network; devcon enable $bdcom_network; CheckFileExist}
        2{$connection = "Iskratel"; devcon disable $bdcom_network; devcon disable $iskratel_network; devcon enable $iskratel_network; CheckFileExist}
        3{$connection = "BDCOM"; devcon disable $bdcom_network; devcon disable $iskratel_network; devcon enable $bdcom_network; CheckFileExist}
        4{Escape}
